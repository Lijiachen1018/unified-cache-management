...
python -m PyInstaller --noconfirm --onefile --windowed --name UCMObsDeploy --add-data "examples/observability/prometheus_grafana/prometheus.yml;." --add-data "examples/observability/prometheus_grafana/docker-compose.yaml;." --add-data "examples/observability/prometheus_grafana/grafana-datasource.yml;." --add-data "examples/observability/prometheus_grafana/grafana-dashboard-provider.yml;." --add-data "examples/observability/prometheus_grafana/dashboards;dashboards" !DLL_FLAGS! "examples/observability/prometheus_grafana/windows_deploy/deploy_client.pyw"
